...
- (void)webViewDidStartLoad:(UIWebView*)sender
{
   ...
   timer = [NSTimer scheduledTimerWithTimeInterval:15 target:self selector:@selector(countUp) userInfo:nil repeats:YES];
    NSLog(@"Timer :: %@",timer);
...
{
    NSLog(@"inside count");
    self.addressLabel.text = @"Loading...(Network connectivity is slow)";
}
